...
def bcrypt_hash(password):
    pass_bytes = password.encode()                                      # Encode the raw password
    pass_hash_bytes = bcrypt.hashpw(pass_bytes, bcrypt.gensalt(14))     # Hash the encoded and use a generated salt
    return pass_hash_bytes.decode()                                     # return hashed password
