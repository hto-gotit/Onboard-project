...
class CategoryList(Resource):
    ...
    @classmethod
    def get(cls):
        category_list_schema = CategorySchema(many=True)            # declare the Schemas of categories
        try:
            return category_list_schema.dump(CategoryModel.find_all()), 200     # try getting all categories
        except:
